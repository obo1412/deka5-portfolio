  ...
  Engineer: [
    {
      ...
      description:
        "엔진 상단을 그저 가리기만 하는 '뷰티커버'와는 다릅니다. 헤드커버는 내연기관 엔진의 최상단에 위치하며, 실린더 캠샤프트를 보호하고 내연기관의 오염된 불완전연소(블로바이) 가스를 다시 재순환 시키는 역할을 하고 있습니다. 헤드커버를 설계하고 연구하며, 필터와 순환장치(벤틸레이션)에 대해 깊게 공부하게 되었습니다. 금형/사출 장치에 대해서도     현대/기아, GM, 중국길리자동차 등에 들어가는 헤드커버를 설계하고 양산 경험이 있습니다. 대표 차종으로는 현대/기아 경차 엔진인 [카파]엔진과 중형차 [세타]엔진 대형차 [람다]엔진 헤드커버 등이 있습니다.",
      detail: {
